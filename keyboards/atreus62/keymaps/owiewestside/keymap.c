...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DEFAULT] = LAYOUT( /* qwerty */
    ...
    KC_LCTL,  KC_LGUI, KC_LALT, KC_BSLS,  MO(_NAV),KC_BSPC, KC_ENT,  KC_RSFT,   KC_SPC,  KC_DEL,  KC_RSFT, KC_EQUAL,KC_ENT,  KC_RCTL
  ),
  ...
  [_NAV] = LAYOUT(
    ...
    TO(RESET),     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS ,
