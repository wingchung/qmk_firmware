...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_6x6(
     ...
     KC_GRAVE,KC_LCTL,KC_BSLASH,LGUI(KC_N),LGUI(KC_V),KC_DEL,                       KC_PLUS,KC_MINS,KC_COMM,KC_LEFT,KC_DOWN,KC_RIGHT,
                      LGUI(KC_W),KC_LALT,                                                       KC_LALT, KC_EQL,
                                      KC_SPC ,KC_LCMD,                        KC_LCMD,KC_ENT,
                                      LGUI(KC_Z),SGUI(KC_V),                        KC_MINS,KC_PGUP,
                                      LGUI(KC_S),LGUI(KC_W),                        KC_PLUS,KC_PGDOWN
  ),
