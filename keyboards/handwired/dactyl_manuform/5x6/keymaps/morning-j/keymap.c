...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_5x6(
     ...
     LT(_RAISE,KC_CAPS), KC_A  , KC_S  , KC_D  , KC_F  , KC_G  ,                         KC_H  , KC_J  , KC_K  , KC_L  ,KC_SCLN,KC_ENT,
     KC_LSFT, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                         KC_N  , KC_M  ,KC_COMM,KC_DOT , KC_UP ,KC_RSFT,
                      LGUI(KC_W),KC_LALT,                                                       KC_LALT, LT(_LOWER,KC_EQL),
  ...
  [_RAISE] = LAYOUT_5x6(
       ...
       _______,_______,_______,_______,_______,_______,                        LALT(LGUI(KC_M)),LGUI(KC_TAB),LALT(RGUI(KC_LEFT)),LALT(RGUI(KC_RGHT)),RGUI(KC_RBRC),KC_SLEP,
